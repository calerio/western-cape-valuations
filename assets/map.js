...
const MUNIS = fetch('data/geo/wc-municipalities.geojson').then(r => r.json()).catch(() => null);
...
const DB_CONFIG_URL = 'https://nxeasppmwvzcqbbgrdvf.supabase.co/storage/v1/object/public/valuations/b-9dadc03c7f1f/config.json';
